...
game_over=False
# when we dont know the number of iteratives, we use the while loop.
# for example, the user may guess the correct word in four or five attempts.
# while loop works best for such conditions.
